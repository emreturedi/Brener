...
window.BrenerApp.Dashboard = {
    render(container) {
        ...
        let dashboardHtml = `
                ...
                <div class="card stat-card">
                    <div class="stat-info">
                        ...
                        <span class="stat-desc down" style="color: var(--warning);">
                            Bütçe Kullanımı: %${((totalSpent/totalBudget)*100).toFixed(0)}
                        </span>
                    </div>
            ...
            <!-- Active Project Focus & Recent Actions -->
            <div class="grid-2col">
                <!-- Active Project Card -->
                <div class="card" style="border-left: 4px solid var(--primary);">
                    ...
                    <p style="font-size: 0.8rem; color: var(--text-muted); margin-bottom: 20px;">
                        Loc: ${activeProj.location} | Proje Şefi: ${activeProj.manager}
                    </p>
                ...
                <div class="card">
                    ...
                    <div style="display: flex; flex-direction: column; gap: 12px;">
                        <div style="display: flex; gap: 12px; border-left: 2px solid var(--primary); padding-left: 12px;">
                            <div style="font-size: 0.75rem; color: var(--text-muted);">Bugün 15:42</div>
                        ...
                        <div style="display: flex; gap: 12px; border-left: 2px solid var(--secondary); padding-left: 12px;">
                            <div style="font-size: 0.75rem; color: var(--text-muted);">Dün 17:15</div>
                            <div style="font-size: 0.85rem; font-weight: 500;">
                        ...
                        <div style="display: flex; gap: 12px; border-left: 2px solid var(--success); padding-left: 12px;">
                            <div style="font-size: 0.75rem; color: var(--text-muted);">22 Haz</div>
                            <div style="font-size: 0.85rem; font-weight: 500;">
